...
export function EventItem({
    ...
    return (
        <div
            className={`absolute left-0 right-0 flex flex-col items-center justify-start p-1 text-xs shadow-sm transition-all overflow-hidden cursor-pointer bg-blue-200 text-gray-800
