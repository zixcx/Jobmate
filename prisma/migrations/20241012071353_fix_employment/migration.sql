/*
  ...
  - Added the required column `age` to the `Employment` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Employment" ("created_at", "id", "name", "position", "storeId", "updated_at", "userId") SELECT "created_at", "id", "name", "position", "storeId", "updated_at", "userId" FROM "Employment";
